          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="${pageContext.request.contextPath }/board/register"><i class="fa fa-circle-o"></i> 게시판 글쓰기</a></li>
                <li><a href="${pageContext.request.contextPath }/board/listAll"><i class="fa fa-circle-o"></i> 게시판 글목록</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
